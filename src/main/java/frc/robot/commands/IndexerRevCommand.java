...
public class IndexerRevCommand extends CommandBase {
  ...
  public void initialize() {
    System.out.println("RevIndexer-Init");
  ...
  public void execute() {
    ...
    if (m_indexer.isRunning() ){  //either Mag full or ball next to shooter
      m_indexer.stop();
      System.out.println("RevIndexer-Exec-stop");
    }
    else{
      m_indexer.reverse();;
      System.out.println("RevIndexer-Exec-start");
    }
  ...
  public void end(boolean interrupted) {
    System.out.println("RevIndexer-Exec-END");
    //m_indexer.stop();
  }
